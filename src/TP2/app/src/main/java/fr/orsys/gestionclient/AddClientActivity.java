...
public class AddClientActivity extends ActionBarActivity {
    ...
    public void addClient(View view) {
        ...
        Client.Sexe sexe = (checkedRadioButtonId == R.id.manRadioButton) ? Client.Sexe.MAN : Client.Sexe.WOMAN;
        Log.d(TAG, "Sexe : " + sexe);
        ...
        boolean activeValue = activeSwitch.isChecked();
        Log.d(TAG, "Actif : " + activeValue);

        // Ajout du client dans la liste

        Client client = new Client(nameValue, firstnameValue, sexe, emailValue, ageValue, level,activeValue);
